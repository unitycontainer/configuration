...
{
    /// <summary>
    /// Base class for configuration elements that generate <see cref="IInjectionMember"/>
    ...
    public abstract class InjectionMemberElement : DeserializableConfigurationElement
    {
        ...
        public abstract IEnumerable<IInjectionMember> GetInjectionMembers(IUnityContainer container, Type fromType, Type toType, string name);
